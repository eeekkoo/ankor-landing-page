    ...
    <GeistProvider>
      ...
      <Radix.RadixProvider>
          ...
          components={{
            ...
            h3: (props) => (
              <Radix.Heading
                mt={6}
                mb={1}
                sx={{ fontWeight: 500, fontSize: 5, lineHeight: '23px' }}
                {...props}
                as="h3"
              />
            ),
            ...
            p: (props) => (
              <Radix.Text
                ...
                mb={3}
                {...props}
                sx={{ lineHeight: '27px', letterSpacing: 0, ...props.sx }}
                as="p"
              />
            ),
            a: ({ href = '', ...props }) => {
            ...
            Demo: (props) => (
              <Radix.Box sx={{ display: ['none', 'block'] }}>
                ...
                <Radix.Heading
                  mt={6}
                  mb={1}
                  sx={{ fontWeight: 500, fontSize: 4, lineHeight: '27px' }}
                  {...props}
                  as="h3"
                >
                  One last thing
        ...
        >
          <Head>
            <title>Modulz</title>
            <link rel="icon" href={isDarkMode ? '/favicon-new.png' : '/favicon-new.png'} />
